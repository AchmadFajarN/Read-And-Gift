    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Sign In to Donate</h2>
          <p className="text-gray-600 mb-6">
            Please sign in to your account to start donating books to the BookShare community.
          </p>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Donation Submitted!</h2>
          <p className="text-gray-600 mb-6">
            Thank you for donating "{formData.title}" to the BookShare community. Your book will be reviewed and made available to other readers soon.
          </p>
          <div className="space-y-3">
            <button
        ...
        {step === 'form' && (
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Share your books with fellow readers in the community</p>
            </div>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
                  ...
                  <div className="flex-shrink-0">
                    {formData.coverPreview ? (
                      ...
                      <label className="w-32 h-48 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-green-500 transition-colors duration-200">
                        ...
                        <span className="text-sm text-gray-500 text-center">Upload Cover</span>
                        <input
                          type="file"
                          accept="image/*"
              ...
              {/* Condition */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-3">Book Condition *</label>
                  ...
                  {conditions.map((condition) => (
                    <label key={condition.value} className="cursor-pointer">
                      ...
                      <div className={`p-4 border-2 rounded-lg transition-all duration-200 ${
                        ...
                        <div className="font-medium text-gray-900 mb-1">{condition.value}</div>
        ...
        {step === 'location' && (
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">How should interested readers contact you?</p>
            </div>
                ...
                <div className="space-y-3">
                  <label className="flex items-center">
                    <input
                      ...
                      onChange={(e) => setLocationData(prev => ({ ...prev, contactMethod: e.target.value }))}
                      className="mr-3"
                    />
                    <span>Email (we'll share your email with interested readers)</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
              ...
              {locationData.contactMethod === 'phone' && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setLocationData(prev => ({ ...prev, phoneNumber: e.target.value }))}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
