            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  ...
                  stories, and spreading the joy of reading through our donation
                  platform.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Discover the books everyone's talking about and join the
              conversation
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Why Choose Read and Give?
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              More than just a book platform - we're building a community of
              passionate readers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Find your next favorite book with our intelligent recommendation
                system and advanced filtering options.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Read authentic reviews from fellow book lovers and share your
                own thoughts to help others discover great reads.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Give your books a second life by donating them to other readers,
                or find free books from generous community members.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 leading-relaxed">
            Join thousands of book enthusiasts who have already discovered their
            next great read through Read and Give.
          </p>
